...
#if !defined(CONFIG_ARCH_QSD8X50) && !defined(CONFIG_ARCH_MSM7X27A)
#include <mach/scm.h>
#else	/* CONFIG_ARCH_QSD8X50 && CONFIG_ARCH_MSM7X27A */
...
#endif	/* CONFIG_ARCH_QSD8X50 && CONFIG_ARCH_MSM7X27A */
